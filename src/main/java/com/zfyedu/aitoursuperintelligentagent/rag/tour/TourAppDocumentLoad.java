...
//@Component
@Slf4j
public class TourAppDocumentLoad {


    private final ResourcePatternResolver resource;

    TourAppDocumentLoad(ResourcePatternResolver resource) {
    ...
    public List<Document> loadMarkdown() {
        ...
        //加载全部的文档
        try {
            Resource[] resources = resource.getResources("classpath:document/tour/*.md");
            //添加文档进列表
